...
export const BERANDA: Record<Lang, any> = {
  id: {
    ...
    fKirim: 'Kirim Pesan', fOk: '✓ Terkirim. Kami balas ke email lu, biasanya dalam satu hari kerja.',
  ...
  en: {
    ...
    fKirim: 'Send Message', fOk: '✓ Sent. We reply to your email, usually within one business day.',
